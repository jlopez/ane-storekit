...
public class BillingService extends Service implements ServiceConnection {
    ...
    private static BillingListener mListener;
    ...
    public class RequestPurchase extends BillingRequest {
         ...
         */
        public RequestPurchase(String itemId, String itemType, String developerPayload, RequestPurchaseCallback callback) {
        ...
        @Override
        protected void responseCodeReceived(ResponseCode responseCode) {
            mCallback.requestPurchaseResponse(responseCode, mProductId, mProductType, mDeveloperPayload);
        }
    }
    ...
    public class RestoreTransactions extends BillingRequest {
        long mNonce;
        private final RestoreTransactionsCallback mCallback;

        public RestoreTransactions(RestoreTransactionsCallback callback) {
            // This object is never created as a side effect of starting this
            // service so we pass -1 as the startId to indicate that we should
            // not stop this service after executing this request.
            super(-1);
        ...
        @Override
        protected void responseCodeReceived(ResponseCode responseCode) {
            mCallback.restoreTransactionsResponse(responseCode);
        }
    }
     ...
     */
    public boolean requestPurchase(String productId, String itemType, String developerPayload, RequestPurchaseCallback callback) {
